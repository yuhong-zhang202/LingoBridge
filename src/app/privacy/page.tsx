    ...
    <div className="relative h-dvh overflow-hidden bg-bg-page flex flex-col">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-5 pt-2 pb-10 relative z-10 lg:max-w-[640px] lg:mx-auto lg:w-full lg:px-10">
        ...
        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">我们收集什么</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
            邮箱（用于登录与保存你的练习进度），以及你录入的故事与练习记录（录音/文字、整理后的故事、匹配题目、AI 反馈等）。
          </p>
        </section>

        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">用途</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">第三方 AI 处理</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">存储</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">你的权利</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-[16px] font-semibold text-v2-text-primary mb-2 lg:text-[17px]">联系方式</h2>
          <p className="text-[15px] text-v2-text-secondary leading-relaxed">
