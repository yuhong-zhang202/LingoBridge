    ...
    <Card variant="gradient" className="px-5 pt-4 pb-5">
      {isEditing ? (
        <textarea
          ...
          className="w-full min-h-[110px] text-[14px] text-v2-text-primary leading-relaxed bg-bg-muted rounded-[12px] px-3 py-2.5 outline-none resize-none focus:ring-1 focus:ring-brand-primary/30"
          autoFocus
        />
      ) : (
