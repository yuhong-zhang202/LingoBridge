...
export default function SwUpdatePrompt() {
  ...
  return (
    <button
      ...
      className="toast-enter fixed bottom-6 left-1/2 z-50 w-[calc(100%-48px)] max-w-[380px] bg-[#1A1A1A] text-white text-[13px] leading-snug rounded-[14px] px-4 py-3 shadow-lg cursor-pointer flex items-center justify-center gap-2"
    >
      <RefreshCw size={14} />
      有新版本，点此刷新
    </button>
