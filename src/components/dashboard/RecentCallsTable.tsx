...
function Badge({ s }: { s: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium border"
      style={{ color: c, backgroundColor: `${c}18`, borderColor: `${c}35` }}>
            ...
            {visible.map(log => {
              ...
              return (
                <tr key={log.id} className="border-b border-black/[0.03] hover:bg-cream-subtle transition-colors">
                  ...
                  <td className="px-3 py-2 font-semibold text-v2-text-primary whitespace-nowrap">¥{log.estimated_cost_cny.toFixed(4)}</td>
